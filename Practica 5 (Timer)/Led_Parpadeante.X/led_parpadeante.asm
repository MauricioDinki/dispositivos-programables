; RB0 Tiene un led que enciende y apaga por si mismo
...
MAIN
    BTG	    LED		; Cambiar el valor de LED al opuesto actual
    CALL    DELAY	; Llama a la rutina de delay
    BRA	    MAIN	; Regresa a Main

DELAY
    CLRF    TMR0L, 0
    MOVLW   .50		; Asigna 50 a W
    BRA	    ASK		; Llama a la rutina ASK
ASK 
    CPFSEQ  TMR0L, 0	; Compara el valor de TMR0L y W (50)
    BRA	    ASK		; Llama a ASK si el valor no es 50
