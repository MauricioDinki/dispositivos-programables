; Este prgrama es un multiplicador en paralelo de 3 bits
; Multiplica cantidades de 3 bits por lo que el mayor resultado es 49
; La cantidad 1 se encuentra en RA2 RA1 RA0
; La cantidad 2 se encuentra en RA6 RA5 RA4
; El resultado se muestra en PORTB (6 Bits de Salida)
