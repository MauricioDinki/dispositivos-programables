; Bonton concetado en RB4 Para encender y apagr un LED en RD0 
; Con Resistor Pull UP
...
INICIO
    ...
    SETF    TRISA	; Configura TRISA 0111 1111 (8 Entradas)
    CLRF    TRISB	; Configura TRISB 0000 0000 (8 Salidas)
